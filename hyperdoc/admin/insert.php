    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container-fluid"> 
                <div class="row">
                    <div class="col-xl-6">
                     <form method="post" action="eksekusi.php" enctype="multipart/form-data">
            
                
                
                        <div class="form-group mb-3">
                                                <label for="simpleinput">Nama Barang</label>
                                                <input type="text" name="nama" class="form-control">
                                            </div>
						<div class="form-group mb-3">
                                                <label for="simpleinput">Harga Barang</label>
                        ...
                        <div class="form-group mb-3">
                                                <label for="simpleinput">Jenis Barang</label>
                                                <input type="text" name="jenis" class="form-control">
                                            </div>
						 <div class="form-group mb-3">
                                                <label for="example-fileinput">Upload Gambar</label>
                                                <input type="file" name="foto" class="form-control-file">
                                            </div>
                    
                                    
                       <button type="submit" class="btn btn-warning waves-effect waves-light">Tambahkan</button>
