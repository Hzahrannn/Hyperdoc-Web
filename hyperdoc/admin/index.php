        ...
        <div class="wrapper">
            <div class="container-fluid"> 
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card-box">
                            <h4 class="header-title mb-3">Tabel Pertanyaan</h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless table-hover table-centered m-0">
									...
									<tr>
										...
										<td><a href="../menjawab.php?id=<?php echo $row["id_pertanyaan"];?>" ><button type="button" class="btn btn-danger waves-effect waves-light">Jawab</button><td>
					...
					<div class="col-xl-6">
                        <div class="card-box">
                            <h4 class="header-title mb-3">Jawaban Dan Pertanyaan</h4>
